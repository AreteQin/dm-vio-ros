...
////    imageTopic = nh.resolveName("/dji_osdk_ros/fpv_camera_images");
////    imuTopic = nh.resolveName("/dji_osdk_ros/imu");
//    ros::Subscriber imageSub = nh.subscribe("/dji_osdk_ros/fpv_camera_images", 3, &vidCb);
//    ros::Subscriber imuSub = nh.subscribe("/dji_osdk_ros/imu", 50, &imuCb);
//
